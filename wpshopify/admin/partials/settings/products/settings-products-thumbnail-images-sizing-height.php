  ...
  <table class="form-table">
    <tbody>
      <tr valign="top">
        ...
        <th scope="row" class="titledesc" data-wpshopify-setting-input="Products thumbnail height">
        ...
        <td class="wps-input">
          <div id="wps-settings-products-thumbnail-images-sizing-height" data-wpshopify-setting-input="Products thumbnail height"></div>
        </td>
