  ...
  <table class="form-table">
    <tbody>
      <tr valign="top">
        ...
        <th scope="row" class="titledesc" data-wpshopify-setting-input="Products thumbnail width">
        ...
        <td class="wps-input">
          <div id="wps-settings-products-thumbnail-images-sizing-width" data-wpshopify-setting-input="Products thumbnail width"></div>
        </td>
