  ...
  <table class="form-table">
    <tbody>
      <tr valign="top">
        ...
        <th scope="row" class="titledesc" data-wpshopify-setting-input="Products thumbnail crop position">
        ...
        <td class="wps-input">
          <div id="wps-settings-products-thumbnail-images-sizing-crop" data-wpshopify-setting-input="Products thumbnail crop position"></div>
        </td>
