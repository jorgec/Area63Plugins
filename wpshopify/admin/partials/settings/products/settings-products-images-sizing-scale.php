  ...
  <table class="form-table">
    <tbody>
      <tr valign="top">
        ...
        <th scope="row" class="titledesc" data-wpshopify-setting-input="Products Image Scale">
        ...
        <td class="wps-input">
          <div id="wps-settings-products-images-sizing-scale" data-wpshopify-setting-input="Products Image Scale">
