  ...
  <table class="form-table">
    <tbody>
      <tr valign="top">
        ...
        <th scope="row" class="titledesc" data-wpshopify-setting-input="Related products crop position">
        ...
        <td class="wps-input">
          <div id="wps-settings-related-products-images-sizing-crop" data-wpshopify-setting-input="Related products crop position">
