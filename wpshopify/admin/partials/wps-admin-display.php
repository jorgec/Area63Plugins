...
$Settings                 = Factories\DB\Settings_Plugin_Factory::build();
$Backend                  = Factories\Backend_Factory::build($Settings);
...
$shop_name                = $DB_Shop->get_shop_name();
...
<div class="wrap wps-admin-wrap">
  ...
  // require plugin_dir_path( __FILE__ ) . 'wps-tab-content-addons.php';
