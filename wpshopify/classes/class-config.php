...
class Config
{
   ...
   public function __construct()
   {
      ...
      $this->plugin_default_sync_by_webhooks = "product_listings/add, product_listings/update, product_listings/remove";
      ...
      if (!defined('WP_SHOPIFY_ADMIN_REST_API_VERSION')) {
         define('WP_SHOPIFY_ADMIN_REST_API_VERSION', $this->plugin_default_admin_rest_api_version);
      }
      
      if (!defined('WP_SHOPIFY_FREE_BASENAME')) {
         define('WP_SHOPIFY_FREE_BASENAME', $this->plugin_default_free_basename);
      }

      if (!defined('WP_SHOPIFY_PRO_BASENAME')) {
         define('WP_SHOPIFY_PRO_BASENAME', $this->plugin_default_pro_basename);
      }

      if (!defined('WP_SHOPIFY_DEFAULT_SYNC_MEDIA')) {
         define('WP_SHOPIFY_DEFAULT_SYNC_MEDIA', $this->plugin_default_sync_media);
      }

      if (!defined('WP_SHOPIFY_DEFAULT_ALLOW_TRACKING')) {
         define('WP_SHOPIFY_DEFAULT_ALLOW_TRACKING', $this->plugin_default_allow_tracking);
      }
      
      if (!defined('WP_SHOPIFY_DEFAULT_SYNC_BY_WEBHOOKS')) {
         define('WP_SHOPIFY_DEFAULT_SYNC_BY_WEBHOOKS', $this->plugin_default_sync_by_webhooks);
      }

      if (!defined('WP_SHOPIFY_DEFAULT_ENABLE_AUTOMATIC_SYNCING')) {
         define('WP_SHOPIFY_DEFAULT_ENABLE_AUTOMATIC_SYNCING', $this->plugin_default_enable_automatic_syncing);
      }
