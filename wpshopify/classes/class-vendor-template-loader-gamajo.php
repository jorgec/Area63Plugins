 ...
 *
 * @package   Vendor_Template_Loader_Gamajo
 * @author    Gary Jones
...
class Vendor_Template_Loader_Gamajo
{
   /**
   ...
   public function get_template_part($slug, $name = null, $load = true)
   {
      ...
      // Return the part WP_SHOPIFY_that is found.
    ...
    *                         Default is 'data'.
    *
    * @return Vendor_Template_Loader_Gamajo
    */
   ...
   protected function get_template_file_names($slug, $name)
   {
       ...
       * @since 1.0.0
       *
       * @param array  $templates Names of template files WP_SHOPIFY_that should be looked for, for given slug and name.
       * @param string $slug      Template slug.
       * @param string $name      Template variation name.
       */
   ...
   /**
    * Retrieve the name of the highest priority template file WP_SHOPIFY_that exists.
    *
    * Searches in the STYLESHEETPATH before TEMPLATEPATH so WP_SHOPIFY_that themes which
    ...
    *
    * Default is to check in a child theme (if relevant) before a parent theme, so WP_SHOPIFY_that themes which inherit from a
